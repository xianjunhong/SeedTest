...
from frank.handleModule.my_thread.trex_thread import TrexThread
...
class InitCountAnything:
    ...
    def load_config(self):
        ...
        self.ImageFolder = config.get('CountAnything', 'ImageFolder')
        self.ProcessedImageFolder = config.get('CountAnything', 'ProcessedImageFolder')
        # 如果文件夹路径不存在，则建立
        ...
        self.DataFile = config.get('CountAnything', 'DataFile')

        self.EnableSaveInfo = config.getboolean('CountAnything', 'EnableSaveInfo')
    ...
    def connect_signals(self):
        ...
        self.ui.tab_1.btn_rect_choose.clicked.connect(self.choose_rect)
        self.ui.tab_1.btn_clear.clicked.connect(self.clear_display_image)
    ...
    def choose_rect(self):
        ...
        self.ui.tab_1.widget_display.set_allow_draw(self.allow_draw)
        ...
        if self.allow_draw:
            ...
            self.display_image(self.last_frame)
            # 实时展示矩形过程
            self.ui.tab_1.widget_display.rects_updated.connect(self.rects_updated)
    ...
    def trex_handle_finished_result(self,bbox,embedding):
        ...
        # 清理界面上的矩形框
        self.ui.tab_1.widget_display.clear_rect()
    ...
    def start_camera(self):
        ...
        if self.allow_draw:
            ...
            self.ui.tab_1.widget_display.set_allow_draw(self.allow_draw)
            # 按钮恢复为原来的状态
            self.ui.tab_1.btn_rect_choose.setChecked(False)
