...
from .image_acquisition_home import ImageAcquisitionHome
from .image_acquisition_data import ImageAcquisitionData


class ImageAcquisitionUi(QWidget):
    ...
    def setup_ui(self):
        ...
        self.tab_1 = ImageAcquisitionHome()
        self.tab_2 = ImageAcquisitionData()



        # 添加标签页
        self.addSubInterface(self.tab_1, 'tab_1', '图像采集')
