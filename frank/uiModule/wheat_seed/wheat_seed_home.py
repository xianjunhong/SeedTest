...
class WheatSeedHome(QWidget):
    ...
    def setup_ui(self):
        ...
        # 置信度和面积筛选
        self.select_confidence_label = QLabel("置信度：")
        self.select_confidence_label.setFont(self.font)
        self.select_confidence_input = Slider(Qt.Horizontal, self)
        self.form_layout.addRow(self.select_confidence_label, self.select_confidence_input)

        self.select_area_label = QLabel("面积：")
        self.select_area_label.setFont(self.font)
        self.select_area_input = Slider(Qt.Horizontal, self)
        self.form_layout.addRow(self.select_area_label, self.select_area_input)
