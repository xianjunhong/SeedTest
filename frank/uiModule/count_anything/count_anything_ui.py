...
from .count_anything_home import CountAnythingHome
from .count_anything_data import CountAnythingHomeData


class CountAnythingUi(QWidget):

    def __init__(self):
        super().__init__()
        self.setWindowTitle("通用考种")
        # 设置图标
    ...
    def setup_ui(self):
        ...
        self.tab_1 = CountAnythingHome()
        self.tab_2 = CountAnythingHomeData()



        # 添加标签页
        self.addSubInterface(self.tab_1, 'tab_1', 'CountAnyting')
