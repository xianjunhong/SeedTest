...
from .tab_1 import Tab1Widget
from .tab_2 import Tab2Widget
from .tab_3 import Tab3Widget
from .tab_4 import Tab4Widget
...
class Ui(QWidget):
    ...
    def setup_ui(self):
        ...
        self.tab_1 = Tab1Widget()
        self.tab_2 = Tab2Widget()
        self.tab_3 = Tab3Widget()
        self.tab_4 = Tab4Widget()


        # 添加标签页
        self.addSubInterface(self.tab_1, 'tab_1', '考种管理')
        self.addSubInterface(self.tab_2, 'tab_2', '数据管理')
        # self.addSubInterface(self.tab_3, 'tab_3', '考种模型')
        self.addSubInterface(self.tab_4, 'tab_4', 'CountAnything')
