...
class MvCamera():
    ...
    # ch:获得当前节点的访问模式 | en:Get Access model of cur node
    ...
    # en: Set to use only one model,type: MV_NET_TRANS_x. When do not set, priority is to use driver by default
    ...
    # ch:设置枚举命令的回复包类型 | en: Setting the ACK model of devices Discovery
